...
# Parsing Script – TAB - Rev. A

This **Parsing** script is designed for the **TAB** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Parsing – TAB Rev. A

Este script de **Parsing** está diseñado para el modelo **TAB** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
